...
function BannerSlide({ slide, isActive }: { slide: typeof slides[0]; isActive: boolean }) {
  return (
    <div
          ...
          <div className="w-full max-w-7xl mx-auto">
            ...
            <div className="max-w-2xl text-white space-y-4 lg:space-y-5">
              ...
              <div>
                ...
                <div className={`text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black ${slide.textAccent} mt-1`}>
                  {slide.subheadline}
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {slide.stats.map((stat, i) => (
                  <div key={i} className="flex items-center gap-1.5 bg-white/10 backdrop-blur rounded-lg px-3 py-1.5 border border-white/10">
                    <span className="text-white/90 text-xs font-semibold">{stat}</span>
                  </div>
                ))}
              </div>
            </div>
